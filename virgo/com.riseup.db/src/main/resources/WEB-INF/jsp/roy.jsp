...
<link rel="stylesheet" href="/resources/styles/local.css"
	type="text/css" />
...
<body class="main tundra">
	<div id="page">
		...
		<div id="primary-navigation">
			<div id="primary-left"></div>
			<img id="left-curve"
				src="/config-properties/images/menu-curve-left.png" />
			...
			<img id="right-curve"
				src="/config-properties/images/menu-curve-right.png" />
		</div>
		<!-- /primary-navigation -->
		...
		<div id="container">
			<div id="content-no-nav">
				...
				<p>The following properties have been found in
					'org.eclipse.virgo.samples.configuration'.</p>
					...
					<c:choose>
						<c:when test="${empty properties}">
							<tr class="name-sublevel1-odd">
								<td id="property_null" colspan="2">No properties have been
									registered.</td>
							</tr>
						</c:when>
						<c:otherwise>
		...
		<div id="footer-wrapper">
			<div id="footer-left">&copy; Copyright 2008, 2013 VMware Inc.
				Licensed under the Eclipse Public License v1.0.</div>
