...
public class MondrianProperties extends MondrianPropertiesBase {
    ...
    /**
     * <p>Positive integer property that determines how many rows are read from sql executions between checks for whether the current mdx query has been cancelled.<br></br>
     ...
     * </p>
     */
    public transient final IntegerProperty CancelPhaseInterval =
        new IntegerProperty(
            this, "mondrian.rolap.cancelPhaseInterval", 10000);
