...
public class XmlaHandler {
	...
	public OlapConnection getConnection(XmlaRequest request,
		...
		LOGGER.debug("Creating new connection for user ["
				+ request.getUsername() + "] and session [" + sessionId + "]");
		...
		// TODO:[NOTE]MODIFY change the name to .get("DataSourceName")
		// databaseName不能为空
		final String databaseName = request.getProperties().get(
				PropertyDefinition.DataSourceInfo.name());
		//final String databaseName= request.getProperties().get("DataSourceName");

		if (databaseName != null && !databaseName.isEmpty()) {
			System.err.println(databaseName);
		}

		String catalogName = request.getProperties().get(
		...
		if (catalogName == null
			...
			Object restriction = request.getRestrictions().get(
					Property.StandardMemberProperty.CATALOG_NAME.name());
	 ...
	 * Object (Integer, Double, String, other) and canonicalizes them to XSD
	 * data type and corresponding object.
	 * <p>
	 ...
	 * (java.lang.Long) or XSD_INTEGER (java.math.BigInteger)). Worst case is
	 * the value loses precision with any integral representation and must be
	 * returned as a decimal type (Double or java.math.BigDecimal).
	 * <p>
	 * If the input DataType is Decimal, then it attempts to return an
	 * XSD_DOUBLE with value java.lang.Double (and failing that an XSD_DECIMAL
	...
	private void checkFormat(XmlaRequest request) throws XmlaException {
		...
		if (request.isDrillThrough()) {
			...
			final String formatName = properties.get(PropertyDefinition.Format
					.name());
			if (formatName != null) {
				Format format = getFormat(request, null);
			...
			if (axisFormatName != null) {
				AxisFormat axisFormat = Util.lookup(AxisFormat.class,
						axisFormatName, null);
	...
	private void execute(XmlaRequest request, XmlaResponse response)
		...
		final String contentName = properties.get(PropertyDefinition.Content
				.name());
		Content content = Util
				.lookup(Content.class,
						contentName,
		...
		try {
			...
			writer.startElement("root", "xmlns", result == null ? NS_XMLA_EMPTY
					: rowset ? NS_XMLA_ROWSET : NS_XMLA_MDDATASET, "xmlns:xsi",
					NS_XSI, "xmlns:xsd", NS_XSD, "xmlns:EX", NS_XMLA_EX);
			...
			try {
				...
				throw new XmlaException(SERVER_FAULT_FC,
	...
	static void writeDatasetXmlSchema(SaxWriter writer, SetType settype) {
		...
		writer.startElement("xsd:schema", "xmlns:xsd", NS_XSD,
				"targetNamespace", setNsXmla, "xmlns", setNsXmla, "xmlns:xsi",
				NS_XSI, "xmlns:sql", NS_XML_SQL, "elementFormDefault",
				"qualified");
		...
		writer.endElement(); // xsd:sequence
		writer.element("xsd:attribute", "name", "Size", "type",
				XSD_UNSIGNED_INT);
		writer.endElement(); // xsd:complexType
		...
		{ // <CubeInfo>
			...
			{ // <Cube>
				...
				writer.element("xsd:element", "name", "CubeName", "type",
						XSD_STRING);
		...
		{ // <AxesInfo>
			...
			writer.startElement("xsd:sequence");
			{ // <AxisInfo>
				writer.startElement("xsd:element", "name", "AxisInfo",
						"maxOccurs", "unbounded");
				writer.startElement("xsd:complexType");
				writer.startElement("xsd:sequence");
				...
				{ // <HierarchyInfo>
					...
					writer.startElement("xsd:complexType");
					writer.startElement("xsd:sequence");
					writer.startElement("xsd:sequence", "maxOccurs",
							"unbounded");
					writer.element("xsd:element", "name", "UName", "type",
							"PropType");
					writer.element("xsd:element", "name", "Caption", "type",
							"PropType");
					writer.element("xsd:element", "name", "LName", "type",
							"PropType");
					writer.element("xsd:element", "name", "LNum", "type",
							"PropType");
					writer.element("xsd:element", "name", "DisplayInfo",
							"type", "PropType", "minOccurs", 0, "maxOccurs",
							"unbounded");
					if (false)
						writer.element("xsd:element", "name",
								"PARENT_MEMBER_NAME", "type", "PropType",
								"minOccurs", 0, "maxOccurs", "unbounded");
					writer.endElement(); // xsd:sequence

					// This is the Depth element for JPivot??
					writer.startElement("xsd:sequence");
					writer.element("xsd:any", "processContents", "lax",
							"minOccurs", 0, "maxOccurs", "unbounded");
					writer.endElement(); // xsd:sequence

					writer.endElement(); // xsd:sequence
					writer.element("xsd:attribute", "name", "name", "type",
		...
		{ // <CellInfo>
			...
			writer.element("xsd:element", "name", "Expression", "type",
					"PropType");
			writer.endElement(); // xsd:choice
			writer.endElement(); // xsd:sequence
			writer.startElement("xsd:sequence", "maxOccurs", "unbounded",
		...
		{ // <Axis>
			...
			writer.element("xsd:element", "name", "CrossProduct", "type",
					"CrossProductType");
			writer.element("xsd:element", "name", "Tuples", "type",
					"TuplesType");
			writer.element("xsd:element", "name", "Members", "type",
					"MembersType");
			writer.endElement(); // xsd:choice
			writer.element("xsd:attribute", "name", "name", "type", XSD_STRING);
			writer.endElement(); // xsd:complexType
		...
		{ // <Cell>
			...
			writer.element("xsd:element", "name", "Updateable", "type",
					XSD_UNSIGNED_INT);
			writer.element("xsd:element", "name", "Visible", "type",
					XSD_UNSIGNED_INT);
			writer.element("xsd:element", "name", "Expression", "type",
					XSD_STRING);
			writer.endElement(); // xsd:choice
		...
		{ // <root>
			...
			writer.startElement("xsd:complexType");
			writer.startElement("xsd:sequence", "maxOccurs", "unbounded");
			writer.element("xsd:element", "name", "OlapInfo", "type",
					"OlapInfo");
			writer.element("xsd:element", "name", "Axes", "type", "Axes");
			writer.element("xsd:element", "name", "CellData", "type",
					"CellData");
			writer.endElement(); // xsd:sequence
			writer.endElement(); // xsd:complexType
	...
	private QueryResult executeDrillThroughQuery(XmlaRequest request)
		...
		final Map<String, String> properties = request.getProperties();
		String tabFields = properties
				.get(PropertyDefinition.TableFields.name());
		if (tabFields != null && tabFields.length() == 0) {
			tabFields = null;
		}
		final String advancedFlag = properties
				.get(PropertyDefinition.AdvancedFlag.name());
	...
	static class Column {
		...
		Column(String name, int type, int scale) {
			...
			// doc.
			this.encodedName = XmlaUtil.ElementNameEncoder.INSTANCE
					.encode(name);
	...
	static class TabularRowSet implements QueryResult {
		 ...
		 *
		 * <p>
		 * Does not close the ResultSet, on success or failure. Client must do
		 * it.
		 *
		 * @param rs
		 *            Result set
		 ...
		 *
		 * @param tableFieldMap
		 *            Map from table name to a list of the names of the fields
		 *            in the table
		 * @param tableList
		 *            List of table names
		 */
		public TabularRowSet(Map<String, List<String>> tableFieldMap,
			...
			for (String tableName : tableList) {
				...
				for (String fieldName : fieldNames) {
					columns.add(new Column(tableName + "." + fieldName,
				...
				for (int i = 0; i < row.length; i++) {
					...
					if (value == null) {
						...
						if (value instanceof Number) {
							valueString = XmlaUtil
									.normalizeNumericString(valueString);
						}
		...
		public void metadata(SaxWriter writer) {
			writer.startElement("xsd:schema", "xmlns:xsd", NS_XSD,
					"targetNamespace", NS_XMLA_ROWSET, "xmlns", NS_XMLA_ROWSET,
					"xmlns:xsi", NS_XSI, "xmlns:sql", NS_XML_SQL,
			...
			{ // <root>
				...
				writer.startElement("xsd:complexType");
				writer.startElement("xsd:sequence");
				writer.element("xsd:element", "maxOccurs", "unbounded",
			...
			{ // xsd:simpleType name="uuid"
				...
				writer.element("xsd:pattern", "value",
						RowsetDefinition.UUID_PATTERN);
			...
			{ // xsd:complexType name="row"
				...
				for (Column column : columns) {
					writer.element("xsd:element", "minOccurs", 0, "name",
							column.encodedName, "sql:field", column.name,
							"type", column.xsdType);
				}
	...
	private QueryResult executeQuery(XmlaRequest request) throws XmlaException {
		...
		try {
			...
			try {
				...
				throw new XmlaException(SERVER_FAULT_FC,
						HSB_EXECUTE_QUERY_CODE, HSB_EXECUTE_QUERY_FAULT_FS, ex);
			}
		} finally {
			if (!success) {
				if (cellSet != null) {
	...
	static abstract class MDDataSet implements QueryResult {
		...
		private static Property rename(final Property property,
				final String name) {
			return new Property() {
	...
	static class MDDataSet_Multidimensional extends MDDataSet {
		...
		private void olapInfo(SaxWriter writer) throws OlapException {
			...
			for (int i = 0; i < axes.size(); i++) {
				List<Hierarchy> hiers = axisInfo(writer, axes.get(i), "Axis"
						+ i);
			...
			cellProperty(writer, StandardCellProperty.FORMAT_STRING, true,
					"FormatString");
			cellProperty(writer, StandardCellProperty.LANGUAGE, false,
					"Language");
			cellProperty(writer, StandardCellProperty.BACK_COLOR, false,
					"BackColor");
			cellProperty(writer, StandardCellProperty.FORE_COLOR, false,
					"ForeColor");
			cellProperty(writer, StandardCellProperty.FONT_FLAGS, false,
					"FontFlags");
		...
		private void cellProperty(SaxWriter writer,
				StandardCellProperty cellProperty, boolean evenEmpty,
				String elementName) {
			if (extra
					.shouldReturnCellProperty(cellSet, cellProperty, evenEmpty)) {
		...
		private void writeHierarchyInfo(SaxWriter writer,
			...
			for (Hierarchy hierarchy : hierarchies) {
				writer.startElement("HierarchyInfo", "name",
						hierarchy.getName());
		...
		private void axes(SaxWriter writer) throws OlapException {
			...
			if (omitDefaultSlicerInfo) {
				...
				axis(writer, slicerAxis,
						getProps(slicerAxis.getAxisMetaData()), "SlicerAxis");
			} else {
				...
				CellSetAxis slicerAxis = cellSet.getFilterAxis();
				final List<Position> slicerPositions = slicerAxis
						.getPositions();
				...
				final List<Member> slicerMembers = slicerPositions.isEmpty() ? Collections
						.<Member> emptyList() : slicerPositions.get(0)
						.getMembers();
				for (Hierarchy hierarchy : hierarchies) {
					...
					final Integer indexPosition = memberMap.get(hierarchy
							.getName());
					...
					if (member != null) {
						if (positionMember != null) {
							writeMember(writer, positionMember, null,
		...
		private void axis(SaxWriter writer, CellSetAxis axis,
				List<Property> props, String axisName) throws OlapException {
			...
			while (position != null) {
				...
				int k = 0;
				for (Member member : position.getMembers()) {
					writeMember(writer, member, prevPosition, nextPosition,
							k++, props);
				}
				writer.endSequence(); // Tuple
		...
		private void slicerAxis(SaxWriter writer, Member member,
			...
			for (Property prop : props) {
				...
				if (longProp == StandardMemberProperty.DISPLAY_INFO) {
					...
					/*
					 * int displayInfo = calculateDisplayInfo((j == 0 ? null :
					 * positions[j - 1]), (j + 1 == positions.length ? null :
					 * positions[j + 1]), member, k, childrenCard.intValue());
					 */
					value = displayInfo;
				} else if (longProp == StandardMemberProperty.DEPTH) {
					value = member.getDepth();
		...
		private int calculateDisplayInfo(Position prevPosition,
			...
			if (nextPosition != null) {
				...
				Member nextMember = nextPosition.getMembers()
						.get(memberOrdinal);
			...
			if (prevPosition != null) {
				...
				Member prevMember = prevPosition.getMembers()
						.get(memberOrdinal);
		...
		private void recurse(SaxWriter writer, List<Integer> pos,
				int axisOrdinal, int[] cellOrdinal) {
			if (axisOrdinal < 0) {
		...
		private void emitCell(SaxWriter writer, List<Integer> pos, int ordinal) {
			...
			for (int i = 0; i < cellProps.size(); i++) {
				...
				if (!extra
						.shouldReturnCellProperty(cellSet, cellPropLong, true)) {
					continue;
				}
				...
				if (!json && cellPropLong == StandardCellProperty.VALUE) {
					...
					if (vi.isDecimal) {
						valueString = XmlaUtil.normalizeNumericString(vi.value
								.toString());
					} else {
						valueString = vi.value.toString();
					}

					writer.startElement(cellProps.get(i).getName(), "xsi:type",
							valueType);
					writer.characters(valueString);
					writer.endElement();
				} else {
	...
	/**
	 * Callback to handle one column, representing the combination of a level
	 * and a property (e.g. [Store].[Store State].[MEMBER_UNIQUE_NAME]) in a
	 * flattened dataset.
	 */
	...
	static class MemberColumnHandler extends ColumnHandler {
		...
		public MemberColumnHandler(Property property, Level level,
				int memberOrdinal) {
	...
	static class MDDataSet_Tabular extends MDDataSet {
		...
		public MDDataSet_Tabular(CellSet cellSet) {
			...
			for (int i = axes.size() - 1; i > 0; i--) {
				...
				dimensionCount += axis.getPositions().get(0).getMembers()
						.size();
			}
			this.empty = empty;
			...
			if (!empty) {
				for (int i = axes.size() - 1; i > 0; i--) {
					...
					// properties.
					List<Property> dimProps = axis.getAxisMetaData()
							.getProperties();
					if (dimProps.size() == 0) {
					...
					for (int j = z0; j < memberOrdinal; j++) {
						...
						for (int k = 0; k <= level.getDepth(); k++) {
							final Level level2 = level.getHierarchy()
									.getLevels().get(k);
							if (level2.getLevelType() == Level.Type.ALL) {
								continue;
							}
							for (Property dimProp : dimProps) {
								columnHandlerList.add(new MemberColumnHandler(
										dimProp, level2, j));
							}
						}
					}
				...
				if (axis >= 2) {
					...
					for (ColumnHandler columnHandler : columnHandlers) {
						if (columnHandler instanceof MemberColumnHandler) {
							...
							columnHandler.write(writer,
									cellSet.getCell(posList), null);
							pos[0]++;// next col.
						}
					}
	...
	private void discover(XmlaRequest request, XmlaResponse response)
		...
		final RowsetDefinition rowsetDefinition = RowsetDefinition
				.valueOf(request.getRequestType());
		...
		writer.startElement(prefix + ":DiscoverResponse", "xmlns:" + prefix,
				NS_XMLA);
		writer.startElement(prefix + ":return");
		writer.startElement("root", "xmlns", NS_XMLA_ROWSET, "xmlns:xsi",
				NS_XSI, "xmlns:xsd", NS_XSD, "xmlns:EX", NS_XMLA_EX);
	...
	protected OlapConnection getConnection(String catalog, String schema,
		...
		try {
			return connectionFactory
					.getConnection(catalog, schema, role, props);
	 ...
	 * the XMLA server will call methods in this interface instead of relying on
	 * the core olap4j interface.
	 *
	 * <p>
	...
	public interface XmlaExtra {
		...
		void getSchemaFunctionList(List<FunctionDefinition> funDefs,
		...
		/**
		 * Returns a list of the data sources in this server. One element per
		 * data source, each element a map whose keys are the XMLA fields
		...
		/**
		 * Returns the number of rows returned by a drillthrough on the
		 * specified cell. Will also return -1 if it cannot determine the
		 * cardinality.
		 */
		int getDrillThroughCount(Cell cell);

		/**
		 * Makes the connection send a command to the server to flush all
		 * caches.
		 */
	...
	private static class XmlaExtraImpl implements XmlaExtra {
		public ResultSet executeDrillthrough(OlapStatement olapStatement,
				String mdx, boolean advanced, String tabFields,
		...
		public List<Map<String, Object>> getDataSources(
			...
			return Collections.singletonList(Olap4jUtil.mapOf("DataSourceName",
					...
					olapDb.getDescription(), "URL", olapDb.getURL(),
					"DataSourceInfo", olapDb.getDataSourceInfo(),
					"ProviderName", olapDb.getProviderName(), "ProviderType",
					providerTypes, "AuthenticationMode", modes));
		}
	...
	public interface ConnectionFactory {
		 ...
		 *
		 * <p>
		 * Properties correspond to the columns of that request:
		 * ""DataSourceName", et cetera.
		 * </p>
		 *
		 * <p>
		 * Returns null if there is no pre-configured response; in which case,
		 * the driver will have to connect to get a response.
		 * </p>
		 *
